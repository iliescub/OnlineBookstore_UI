...
const Checkout: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const orderDto: CreateOrderDto = { userId: currentUser.id, userName: currentUser.name, items: items.map(i => ({ id: i.id, title: i.title, author: i.author, price: i.price, quantity: i.quantity })), shippingAddress: address };
      ...
      <div className="max-w-2xl mx-auto bg-[rgba(15,22,44,0.7)] rounded-3xl p-8 border border-[rgba(124,215,255,0.12)]">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="space-y-4">
            ...
            <div className="p-4 bg-[rgba(124,215,255,0.1)] border border-[rgba(124,215,255,0.2)] rounded-xl">
              <p className="text-sm text-slate-300">
                Payment will be processed securely on the next page. We accept all major credit cards and digital wallets.
              </p>
            </div>
          </div>
